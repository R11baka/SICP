...
;it in the generic arithmetic package. This operation should work for ordinary numbers, rational numbers, and complex numbers.
...
(define t1 (make-complex-from-mag-ang 3 4))
(define r2 (make-complex-from-mag-ang 3 4))
